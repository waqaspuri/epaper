...
function gui_input_change(e) {
    ...
    if (obj.name == 'img_href') { myimgmap.areas[id].ahref = obj.value; } else if (obj.name == 'img_alt') { myimgmap.areas[id].aalt = obj.value; } else if (obj.name == 'img_title') { myimgmap.areas[id].atitle = obj.value; } { myimgmap.areas[id].atarget = obj.value; } {
...
function gui_addArea(id) {
    ...
    var temp = '<table class="table table-bordered"><tbody><tr>';
    temp += '<td><input type="text"  name="img_id" class="img_id" value="' + id + '" readonly="1"/>';
    //temp+= '<input type="checkbox" name="img_active" class="img_active" id="img_active_'+id+'" value="'+id+'">';
    //could be checkbox in the future
    temp += '<input type="radio" name="img_active" class="img_active" id="img_active_' + id + '" value="' + id + '"></td>';
    temp += '<td> <select disabled style="border: none; background: none" name="img_shape" class="img_shape">';
    ...
    // }
    temp += '</select></td>';
    temp += '<input type="hidden" name="img_coords[]" class="img_coords" value="">';
    temp += '<input type="hidden" name="img_href" class="img_href" value="">';
    temp += '<input type="hidden" name="img_alt" class="img_alt" value="">';
    temp += '<td>  <input type="file" name="img_file[]" class="img_file" value=""> </td>';
    temp += '</tr></tbpdy></table>';
